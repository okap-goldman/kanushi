...
const REGIONS_DATA = {
  北海道・東北: {
    ...
    features: {
      characteristics:
        '広大な大地と豊かな自然に恵まれた地域。パワースポットが多く点在し、特に阿寒湖や出羽三山は古くから修験道の聖地として知られています。',
      specialties: [
        'オーガニック野菜',
        '天然水晶',
        '浄化用の岩塩',
  ...
  関東: {
    ...
    features: {
      characteristics:
        '現代的なスピリチュアリティの中心地。都会の中でも静寂を見出し、新しい気づきの形を模索しています。',
      specialties: [
        'オリジナル瞑想アプリ',
        'チャクラ調整ジュエリー',
        '都市型瞑想スペース',
  ...
  中部: {
    ...
    features: {
      characteristics:
        '日本アルプスの麓に位置し、古来からの修験道と現代的なスピリチュアリティが融合する地域。',
      specialties: ['パワーストーン', '浄化用の竹炭', '瞑想用和紙', 'オリジナル香'],
      people: [
        {
          name: '中村修験',
          role: '修験道師',
  ...
  近畿: {
    ...
    features: {
      characteristics:
        '古都の歴史的な寺社仏閣と現代的なスピリチュアリティが調和する地域。伝統的な瞑想法を現代に活かす取り組みが盛ん。',
      specialties: ['伝統的な瞑想具', 'お香', '和紙製マインドフルネスノート', '瞑想用座布団'],
      people: [
        {
          name: '西田禅心',
          role: '禅僧',
  ...
  中国・四国: {
    ...
    features: {
      characteristics:
        '豊かな自然と温泉に恵まれた地域。地域の伝統的な癒しの文化と現代的なヒーリングが融合。',
      specialties: ['ヒーリング用クリスタル', '地元産ハーブティー', '瞑想用クッション', '自然音CD'],
      people: [
        {
          name: '高橋自然',
          role: '自然療法士',
  ...
  九州・沖縄: {
    ...
    features: {
      characteristics:
        '南国特有のエネルギーと島々の神秘的なパワースポットが点在する地域。独自のスピリチュアル文化を育んでいます。',
      specialties: ['浄化用の塩', '南国ハーブ', 'シーグラス瞑想ツール', '島藍染めヨガマット'],
      people: [
        {
          name: '島田波動',
          role: 'シャーマン',
