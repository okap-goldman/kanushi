...
// Message enums
export const messageTypeEnum = pgEnum('message_type', ['text', 'image', 'audio', 'video', 'system']);
...
// AI/Chat enums
export const playlistTypeEnum = pgEnum('playlist_type', ['daily', 'mood', 'activity', 'personalized']);
