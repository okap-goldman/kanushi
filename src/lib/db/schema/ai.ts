...
import { chatRoleEnum, playlistTypeEnum } from './enums';
import { posts } from './post';
import { profiles } from './profile';

// AI playlist table
export const aiPlaylists = pgTable(
  'ai_playlist',
  {
...
export const aiPlaylistPosts = pgTable(
  'ai_playlist_post',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    playlistId: uuid('playlist_id')
      .notNull()
      .references(() => aiPlaylists.id, { onDelete: 'cascade' }),
    postId: uuid('post_id')
      .notNull()
