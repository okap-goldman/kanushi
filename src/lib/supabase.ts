...
const supabaseUrl =
  process.env.EXPO_PUBLIC_SUPABASE_URL || 'https://dpmrgzjvljaacdwggnaf.supabase.co';
const supabaseAnonKey =
  process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY ||
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRwbXJnemp2bGphYWNkd2dnbmFmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDgwMTY0MTMsImV4cCI6MjA2MzU5MjQxM30.myHmmx_dc3NQkPS5rnfw6sEFH24gFmt878K526bgPPY';
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        media_url: Array.isArray(postData.media_url)
          ? JSON.stringify(postData.media_url)
          : postData.media_url,
