...
describe('SearchBar Component', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render search input field and icon', () => {
      const { getByPlaceholderText, getByTestId } = render(<AISearchBar onSearch={mockOnSearch} />);
  ...
  describe('Search Input', () => {
    it('should update value on text input', () => {
      const { getByPlaceholderText } = render(<AISearchBar onSearch={mockOnSearch} />);
  ...
  describe('Loading State', () => {
    ...
    it('should disable input while loading', () => {
      const { getByPlaceholderText } = render(<AISearchBar onSearch={mockOnSearch} isLoading />);
