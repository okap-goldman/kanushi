...
const SAMPLE_EVENTS = [
  {
    ...
    description: 'Explore the best of Tokyo\'s food scene with over 100 vendors offering traditional and modern Japanese cuisine. The festival will feature food stalls, cooking demonstrations, tasting sessions, and cultural performances throughout the day.\n\nHighlights include:\n- Regional specialties from all over Japan\n- Sake and craft beer tasting area\n- Live cooking demonstrations by renowned chefs\n- Traditional music and dance performances\n- Activities for children including food-themed crafts',
    category: 'food',
    attendees: 458,
    price: 'Free Entry',
    organizer: {
  ...
  },
  {
    ...
    description: 'Learn the traditional art of Sumi-e (Japanese ink painting) with master artist Tanaka Hiroshi. This workshop is suitable for beginners and will cover the basics of brush techniques, composition, and the philosophy behind this ancient art form.\n\nAll materials will be provided, and participants will create their own ink painting to take home. The workshop will be conducted in Japanese with English translation available.',
    category: 'workshop',
    attendees: 24,
    price: '¥5,000',
    organizer: {
  ...
  },
  {
    ...
    description: 'Enjoy a vibrant night market with local crafts, street food, and live music along the Meguro River. As the sun sets, the riverbanks will be illuminated with lanterns creating a magical atmosphere for this summer evening event.\n\nThe market features:\n- Handcrafted goods from local artisans\n- Food stalls offering a variety of cuisines\n- Craft beer and sake tasting\n- Live acoustic performances\n- Riverside seating areas',
    category: 'market',
    attendees: 287,
    price: 'Free Entry',
    organizer: {
  ...
  },
  {
    ...
    description: 'Experience the art and philosophy of Japanese tea ceremony in a beautiful traditional garden setting. This session will introduce participants to the customs, etiquette, and spiritual aspects of this important cultural practice.\n\nThe ceremony will be held in an authentic tea house within the historic Happo-en Garden, providing the perfect serene backdrop for this meditative experience. Participants will enjoy matcha tea and traditional Japanese sweets.',
    category: 'cultural',
    attendees: 18,
    price: '¥3,500',
    organizer: {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.actionBar}>
        ...
        >
          ...
          {attending && <Feather name="check" size={16} color="#FFFFFF" style={styles.attendingIcon} />}
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
